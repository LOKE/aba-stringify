...
const abaStringify = require('./');

function macro(t, header, rows, expected) {
  const actual = abaStringify(header, rows);
...
], fs.readFileSync(path.resolve(__dirname, 'fixtures/first.aba'), 'utf8'));
